...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      description: "E.g., 'Full-Stack Developer & Devops Engineer'",
      validation: (r) => r.required(),
    }),
    defineField({
    ...
    defineField({
      ...
      initialValue: 3000,
      validation: (r) => r.min(1000).max(10000),
    }),
    defineField({
      name: "shortBio",
      title: "Short Bio",
    ...
    defineField({
      ...
      title: "Location",
      type: "string",
      description: "E.g., 'Bangalore, India' or 'Remote'",
    }),
    defineField({
      name: "availability",
      ...
      options: {
        list: [
          { title: "Available for hiring", value: "available" },
