    ...
    <div className="@container/form bg-card border rounded-lg p-4 @md/form:p-6">
      ...
      <form className="space-y-3 @md/form:space-y-4" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          disabled={isPending}
          className="w-full px-4 cursor-pointer py-2 @md/form:px-6 @md/form:py-3 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors font-medium text-sm @md/form:text-base disabled:opacity-50 disabled:cursor-not-allowed"
        >
